				...
				<div class="con_in">
					<div class="s_view_wrap">
						<div class="m_top_nav_wrap">
							...
							<a href="/sv_info/privacy.php" class="active">개인정보처리방침</a>
						...
						<div class="s_view_desc">
							<div class="s_view_info_wrap">
								<div class="s_view_info_label_wrap">
									<div class="s_view_info_label">개인정보처리방침</div>
								...
								<div class="s_view_info_box">
									<div class="board_wrap">
										...
										<dl>
                    <dd>스페이스풀(이하 ‘회사’)는 정보통신망이용촉진 및 정보보호 등에 관한 법률(이하 ‘정보통신망법’) 등에 따라 회원의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침을 수립·공개합니다.</dd>
                    ...
                    <dd>
                        <ol>
                            ...
                            <li>4.	개인정보의 수집 방법
                                <ol>
                                    <li>1)	스페이스풀 PC/모바일회원가입, 고객센터를 통한 유선 상담, 이메일을 통한 온라인 상담, 네이버 톡톡을 통한 온라인 상담</li>
                    ...
                    <dd>
                        <ol>
                            ...
                            <li>2.	회원님 및 법정대리인의 개인정보 조회, 수정은 회사의 개인정보보호책임자에게 서면, 전화, 전자우편 등을 통하여 하실 수 있으며 회사는 이에 대해 지체없이 조치하겠습니다.</li>
                    ...
                    <dd>회사는 회원의 개인정보를 처리함에 있어 개인정보가 분실, 도난, 유출, 위조, 변조 또는 훼손되지 않도록 안전성 확보를 위하여 다음과 같은 기술적/관리적 대책을 강구하고 있습니다.
                        <ol>
                    ...
                    <dt>제10조(개인정보 보호책임자의 연락처)</dt>
                    <dd>
                        회원은 아래의 연락처로 개인정보보호 관련 민원을 개인정보 보호책임자 혹은 담당부서로 신고하실 수 있습니다.
                        <table>
                            <colgroup>
                                <col width="*" span="2">
                            </colgroup>
                            <tbody>
                            <tr>
                                <td class="td_tit">개인정보 보호책임자</td>
                                <td class="td_tit">개인정보 보호담당자</td>
                            </tr>
                            <tr>
                                <td>
                                    <ul>
                                        <li>이름: 박경호</li>
                                        <li>연락처 : <a href="tel:010-2603-2968" class="tel_num">010-2603-2968</a></li>
                                        <li>이메일: <a href="mailto:kunq@spacecloud.kr">weconarts@gmail.com</a>	</li>
                                    </ul>
                                </td>
                                <td>
                                    <ul>
                                        <li>이름: 박희락 </li>
                                        <li>연락처 : <a href="tel:1599-4312" class="tel_num">010-4873-0408 </a></li>
                                        <li>이메일: <a href="mailto:imshow@spacecloud.kr">weconarts@gmail.com</a>	</li>
                                    </ul>
                                </td>
                            </tr>
                            </tbody>
                    ...
                    <dd>
                        <ol>
                            ...
                            <li>2.	이 개인정보처리방침은 2016.07.15일 부터 적용됩니다</li>
                        </ol>
                    </dd>
                </dl>
