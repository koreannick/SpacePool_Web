...
<body>
	<!-- 올랩 -->
	<div id="wrap" class="sub sub_customer sub_board sub_terms">
				...
				<div class="con_in">
					<div class="s_view_wrap">
						<div class="m_top_nav_wrap">
							<a href="/sv_info/terms.php" class="active">이용약관</a>
							<a href="/sv_info/privacy.php" class="">개인정보처리방침</a>
							<a href="/sv_info/email.php" class="">이메일무단수집거부</a>
						</div>
						<div class="s_view_desc">
							<div class="s_view_info_wrap">
								<div class="s_view_info_label_wrap">
									<div class="s_view_info_label">이용약관</div>
								...
								<div class="s_view_info_box">
									<div class="board_wrap">
										...
										<dl>
                    <dt>제 1 조 (목적)</dt>
                    <dd>이 약관은 주식회사 스페이스풀("회사" )가 제공하는 스페이스풀(<a href="http://www.spacepool.co.kr">http://www.spacepool.co.kr</a>) 온라인 서비스(이하 “서비스”라고 합니다.)의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.</dd>
                    <dt>제 2 조 (정의)</dt>
                    <dd>
                        <ol>
                            <li>이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
                                <ol>
                                    <li>1.	 "서비스"라 함은 유휴 공간(이하 “공간”) 정보의 공유 및 예약을 위하여 “회사”가 스페이스풀를 통해 제공하는 온라인 서비스를 말합니다.</li>
                                    <li>2.	“사이트”라 함은 “회사” 가 “서비스”를 운영하는 웹사이트를 의미하며, 현재는 (<a href="http://www.spacepool.co.kr">http://www.spacepool.co.kr</a>) 입니다.</li>
                                    <li>3.	회사의 "서비스"에 접속하여 이 약관에 따라 "회사"와 이용계약을 체결하고 "회사"가 제공하는 "서비스"를 이용하는 고객은 서비스 이용목적에 따라 “게스트회원”과 “호스트회원”으로 구분됩니다.
                                        <ol>
                                            ...
                                            <li>B.	호스트회원: “스페이스풀 호스트 이용약관”에 따라 “회사”와 이용계약을 체결하고 “회사”가 제공하는 “서비스”를 통해 “공간” 및 컨텐츠를 등록하거나 제안할 수 있는 회원을 말합니다.</li>
                                        </ol>
                                    </li>
                                    <li>4.	"아이디"라 함은 "회원"의 식별과 "서비스" 이용을 위하여 "회원"이 정한 온라인 포털서비스 네이버(<a href="http://www.naver.com" target="_blank" title="새창열림">www.naver.com</a>, 이하 “네이버”)의 아이디(ID)를 말합니다.</li>
                                    <li>5.	"비밀번호"라 함은 "회원"이 부여 받은 "아이디”와 일치되는 "회원"임을 확인하고 비밀을 보호하기 위해 "회원" 자신이 정한 온라인 “네이버”의 비빌번호를 말합니다.</li>
                    ...
                    <dd>
                        <ol>
                            <li>1.	이용계약은 "회원"이 되고자 하는 자(이하 "회원가입신청자")가 이 약관의 내용에 대하여 동의를 한 다음 회원가입신청을 하고 "회사"가 이러한 신청에 대하여 승낙함으로써 체결됩니다. “회사”는 이용계약이 체결되면 네이버주식회사로부터 “회원”의 성명, 연락처, 전자우편주소를 제공받아 보관하며, “서비스” 제공 목적 범위 내에서 이를 “호스트회원”에게 제공할 수 있습니다.</li>
                    ...
                    <dd>“회원”은 회원가입신청 시 기재한 사항이 변경되었을 경우 “네이버” 개인정보관리화면을 통하여 수정하여야 합니다. “회원”이 변경사항을 수정하지 아니하여 발생한 불이익에 대하여 “회사”는 책임지지 않습니다.</dd>
                    ...
                    <dd>
                        <ol>
                            ...
                            <li>2.	“회사”가 개인정보의 보호를 위하여 상당한 주의를 기울였음에도 불구하고, “호스트회원”이 관련 법령 및 “스페이스풀 호스트 이용약관”을 위반하여 “회원”의 개인정보를 유출 또는 유용한 경우 “회사”는 그에 대하여 아무런 책임을 부담하지 않습니다.</li>
                        </ol>
                    </dd>
                    ...
                    <dd>
                        <ol>
                            <li>1.	"회원"은 다음 행위를 하여서는 안 됩니다.
                                <ol>
                                    <li>A.	회원가입신청 또는 회원정보변경(“네이버”에서의 정보변경 포함) 시 및 공간 예약 신청 또는 변경 시 허위내용의 등록</li>
                                    <li>B.	타인의 정보도용</li>
                    ...
                    <dd>
                        <ol>
                            ...
                            <li>2.	2.	"회사"는 전항에도 불구하고, "주민등록법"을 위반한 명의도용 및 결제도용, "저작권법" 및 "컴퓨터프로그램보호법"을 위반한 불법프로그램의 제공 및 운영방해, "정보통신망법"을 위반한 불법통신 및 해킹, 악성프로그램의 배포, 접속권한 초과행위 등과 같이 관련 법령을 위반한 경우에는 즉시 영구이용정지를 할 수 있습니다. 본 항에 따른 영구이용정지 시 "서비스" 이용을 통해 획득한 기타 혜택 등도 모두 소멸되며, "회사"는 이에 대해 별도로 보상하지 않습니다.</li>
                    ...
                    <dt>부칙</dt>
                    <dd>이 약관은 2016년 11월 20일부터 적용됩니다.</dd>
                </dl>
