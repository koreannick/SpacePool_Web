<?
    ...
    $home_dir      ="/home/hosting_users/lucaspark90/www/plugin/kcpcert"; // ct_cll 절대경로 ( bin 전까지 )
...
<html xmlns="http://www.w3.org/1999/xhtml" >
    ...
    <body oncontextmenu="return false;" ondragstart="return false;" onselectstart="return false;">
		...
		opener.document.form0.kcp_code.value = "<?=$res_cd?>";
		if("<?=$res_cd?>"=="0000") {
				$opener.$("input[name=cert_no]").val("<?php echo $cert_no; ?>").attr("readonly", true);
			$opener.$("input[name=tel2]").val("<?php echo $phone_no; ?>").attr("readonly", true);
			opener.document.getElementById("ins1_btn").style.display = "none";
			self.close();
		} else {
