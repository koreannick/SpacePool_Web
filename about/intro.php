	  ...
	  <div class="sub_visual_wrap">
			...
			<div class="con_wrap">
				...
				<div class="con_in">
						...
						<div class="about_box_04_left">
							...
							<div class="about_con">
								...
								<div class="about_con_box">
									...
									<div class="about_con_desc">
										<a href="mailto:admin@spacepool.co.kr">spacepool@naver.com</a>
									</div>
								</div>
								<div class="about_con_box">
									<div class="about_con_label">
									...
									<div class="about_con_desc">
										부산 금정구 장전동 수림로 93번길 62 501호
									</div>
								</div>
							</div>
							<div>
								<a href="/partner/contact.php" class="main_go_space_regi go_contact" style="border:none;">
									제휴문의 바로가기
								</a>
							</div>
						</div>
                    ...
                    <!--div class="about_btn_wrap">
                    	<div class="a_btn_box"><a href="/space/list.php" class="about_btn">공간찾기</a></div>
                        <div class="a_btn_box"><a href="/member/space_apply.php" class="about_btn">공간등록하기</a></div>
                    </div-->
				</div>
			</div>
		</div>
