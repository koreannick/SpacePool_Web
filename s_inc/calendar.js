    ...
    function fc_generateHTML() {
        var html = '<TABLE><TR><TD CLASS="fc_head" COLSPAN="6">달력</TD><TD CLASS="fc_date" onMouseover="this.className = \'fc_dateHover\';" onMouseout="this.className=\'fc_date\';" onClick="getCalendar(\'' + this.id + '\').hide();"><B>X</B></TD></TR>';
        ...
        html += '<TR><TD class="fc_wknd" WIDTH="14%">일</TD><TD WIDTH="14%" CLASS="fc_wk">월</TD><TD WIDTH="14%" CLASS="fc_wk">화</TD><TD WIDTH="14%" CLASS="fc_wk">수</TD><TD WIDTH="14%" CLASS="fc_wk">목</TD><TD WIDTH="14%" CLASS="fc_wk">금</TD><TD class="fc_wknd1" WIDTH="14%">토</TD></TR>';
        html += '<TR>';
        var dow = 0;
        var i, style;
        var totald = fc_monthLength(this.showDate);
        var totald2 = fc_firstDOW(this.showDate)+1;
		if(totald2<7){
			for (i = 0; i < totald2; i++) {
				dow++;
				html += '<TD> </TD>';
