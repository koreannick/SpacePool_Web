...
if($uid){
	$result = mysql_query("select e1,e1_price,e2,e2_price,p_limit,size1,size2,n_talk,bimg,img1,img2,img3,p_opt,id,pay_auth,pay_card,pay_bank,pay_bank_1,pay_bank_2,pay_bank_3,pay_offline,e3_price,e4_price from es_product where uid=$uid");
